...
function Cashier() {
  ...
  <>
        ...
        <CashierModal isOpen={isHospitalModalOpened} />
       <div className='text-right bg-white p-8 border-box h-[90%]'>
        <Button variant="contained" color="primary" style={{marginBottom: "3vh", fontWeight: 700}} onClick={toggleHospitalModal}>ADD CASHIER</Button>
